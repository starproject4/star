...
<head>
	...
	<style type="text/css">
    	...
    	.content form table tr td:nth-child(2), .content form table tr td:nth-child(4){    		
    		padding-left: 2%;  	
    	}
    	.content form table tr td:nth-child(3){
    		padding-left: 6%;
    	}
        .star-btn{
        	margin-top: 20px;   	
   ...
   <jsp:include page="/resources/templates/footer.jsp"></jsp:include>
    ...
    <script type="text/javascript">
    	$(function(){
    		...
    		$("#del").click(function() {
	 			if(confirm("삭제하시겠습니까?")){ 	
	 				location.href="/star/product/delete?no=${bean.no}";
	 			}else{
	 				return false;	 				
	 			}
	 		});
