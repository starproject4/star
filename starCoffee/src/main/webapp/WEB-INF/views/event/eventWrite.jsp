...
<!-- header link -->
   ...
   <!-- 여기부터 본문 -->
    <div class="container content">
		...
		<!-- 여기부터 입력합니다 -->
			<h1>이벤트 등록</h1>
			<form action="/star/event/insert" method="post" enctype="multipart/form-data" >
				...
				<div class="star-btn button col-sm-12">
					<input class="btn btn-success"  type="submit" id="insert" onclick="return sbmbtn();" value="등록"/>
