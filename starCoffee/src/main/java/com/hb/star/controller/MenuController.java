...
public class MenuController {
	...
	public String menuDetail(@RequestParam("no") int no, Model model, HttpSession session){
		MenuDao mapper = sqlSession.getMapper(MenuDao.class);
	...
	@RequestMapping("/edit")
	public String menuEdit(Model model, @RequestParam("no") int no){
		MenuDao mapper = sqlSession.getMapper(MenuDao.class);
		model.addAttribute("bean", mapper.selectOne(no));		
	...
	public String menuUpdate(MenuVo bean, MultipartFile file, HttpServletRequest req){
		MenuDao mapper = sqlSession.getMapper(MenuDao.class);
